...
int32_t  si5351_correction = 0;         //Frequency correction factor for Adafruit Si5351a Breakout Board
uint8_t  si5351bx_rdiv = 0;             // 0-7, CLK pin sees fout/(2**rdiv) // Note that 0 means divide by 1
uint8_t  si5351bx_drive[3] = {3, 3, 3}; // 0=2ma 1=4ma 2=6ma 3=8ma for CLK 0,1,2 - Set all clock output levels to 8ma
